        ...
        return [
            ...
            'newsItems' => [
                [
                    ...
                    'tag' => 'Partner update',
                    'status' => 'Community conservation watch',
                    'title' => 'Community-linked conservation support',
                    'body' => 'Browse Daboville Foundation updates for environmental and community work that can strengthen the wider conservation setting around the park.',
                    'image' => self::optimizedAsset('bckgrndHome/hbg1.jpg'),
                    'image_alt' => 'Mountain landscape used as the featured visual for Daboville Foundation updates',
                    'url' => 'https://www.dabovillefoundation.org/',
                    'external' => true,
                    'cta' => 'Open source',
                ],
                [
                    ...
                    'tag' => 'Landscape news',
                    'status' => 'Landscape connectivity desk',
                    'title' => 'Corridor stories across connected habitats',
                    'body' => 'The Biodiversity Corridors site highlights landscape-scale conservation efforts that help explain how protected areas connect beyond a single park boundary.',
                    'image' => self::optimizedAsset('bckgrndHome/hbg2.jpg'),
                    'image_alt' => 'Ridges and connected habitat landscape used for Biodiversity Corridors coverage',
                    'url' => 'https://bdcorridors.wordpress.com/corridor-sites/',
                    'external' => true,
                    'cta' => 'View coverage',
                ],
                [
                    'source' => 'MBCFI',
                    'tag' => 'Mindoro partner',
                    'status' => 'Island biodiversity desk',
                    'title' => 'Island biodiversity initiatives',
                    'body' => 'Mindoro Biodiversity Conservation Foundation Inc. shares work tied to habitat protection, species conservation, and environmental action across the island.',
                    'image' => self::optimizedAsset('bckgrndHome/hbg3.jpeg'),
                    'image_alt' => 'Forest and habitat visual representing MBCFI conservation stories',
                    'url' => 'https://www.mbcfi.org.ph/',
                    'external' => true,
                    'cta' => 'Open source',
                ],
                [
                    'source' => 'Tamaraw DENR',
                    'tag' => 'Field updates',
                    'status' => 'Field bulletin source',
                    'title' => 'Tamaraw-related public announcements',
                    'body' => 'Follow Tamaraw DENR for outreach posts and public-facing conservation updates connected to the park\'s most iconic flagship species.',
                    'image' => self::optimizedAsset('bckgrndHome/tamaraw.JPG'),
                    'image_alt' => 'Tamaraw visual representing field bulletins and conservation updates',
                    'url' => 'https://www.facebook.com/tamarawdenr/',
                    'external' => true,
                    'cta' => 'View updates',
                ],
